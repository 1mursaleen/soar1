...
const ExpenseStatistics = () => {
  ...
  return (
    <div aria-labelledby="expense-statistics-title">
      <h4
        id="expense-statistics-title"
        ...
        <div className="flex items-center justify-center">
          {statisticsData?.data?.length > 0 && (
            <div
              ...
              role="img"
              aria-label="Pie chart showing expense distribution across Entertainment, Bill Expense, Others, and Investment"
            >
              <ResponsiveContainer>
                <PieChart>
                  <Pie
